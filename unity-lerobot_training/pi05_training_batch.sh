#!/bin/bash
#SBATCH --job-name=pi05_training_lowerBS           # Job name
#SBATCH --partition=gpu                    # Partition (queue)
#SBATCH --gres=gpu:1
#SBATCH --constraint=a100-80g
#SBATCH --mem=32G                          # Memory
#SBATCH --time=10:00:00                    # Time limit hh:mm:ss
#SBATCH --output=logs/pi05_bs16_%j.out  # Standard output log
#SBATCH --error=logs/pi05_bs16_%j.err   # Standard error log
...
lerobot-train \
  ...
  --policy.device=cuda \
  --batch_size=16 \
  --policy.repo_id=grahamwichhh/v2_pi05_so101_lego-to-mug_50ep
